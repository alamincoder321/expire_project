const purchaseorderInvoice = Vue.component('purchaseorder-invoice', {
    template: `
        <div>
            <div class="row">
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        <table _a584de style="margin-top: 5px;">
                            <tr>
                                <td><strong>Total:</strong></td>
                                <td style="text-align:right;font-weight: bold;">{{ purchase.PurchaseMaster_TotalAmount }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
    ...
    methods: {
        getPurchase() {
            axios.post('/get_purchase_orders', { purchaseId: this.purchase_id }).then(res => {
            ...
            printWindow.document.write(`
                ...
                <body>
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 text-center">
                                  <img src="/uploads/company_profile_thum/${this.currentBranch.Company_Logo_thum}" alt="Logo" style="height:80px;" />
                            </div>
