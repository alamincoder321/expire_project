...
<script>
	...
	new Vue({
		...
		methods: {
			...
			getSales() {
				axios.post('/get_sales?status=a', this.filter)
					.then(res => {
			...
			getBankPaid() {
				axios.post('/get_sales_record?status=a', this.filter)
					.then(res => {
			...
			getSaleReturn() {
				...
				axios.post('/get_sale_returns?without=delete', data)
					.then(res => {
						this.saleReturns = res.data.returns;
					})
			},
			getExchange() {
				axios.post('/get_exchanges?without=delete', this.filter)
					.then(res => {
