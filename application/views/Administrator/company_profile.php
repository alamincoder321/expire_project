			...
			<?php if ($selected) { ?>
				<form class="form-vertical" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>company_profile_Update">
					...
					<table class="table table-bordered">
						<tr>
							<th colspan="2">Site Verification & Pixel</th>
						</tr>
						<tr>
							<td>
								<div class="form-group" style="margin-top:15px">
									<label class="control-label" for="googleVerification"> Google Verification </label>
									<div>
										<textarea id="googleVerification" name="googleVerification" class="form-control"><?php echo $selected->googleVerification ?? ''; ?></textarea>
									</div>
								</div>
							</td>
							<td>
								<div class="form-group" style="margin-top:15px">
									<label class="control-label" for="gtagId"> Google Tag Id </label>
									<div>
										<textarea id="gtagId" name="gtagId" class="form-control"><?php echo $selected->gtagId ?? ''; ?></textarea>
									</div>
								</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div class="form-group" style="margin-top:15px">
									<label class="control-label" for="bingVerification"> Bing Vification </label>
									<div>
										<textarea id="bingVerification" name="bingVerification" class="form-control"><?php echo $selected->bingVerification ?? ''; ?></textarea>
									</div>
								</div>
							</td>
							<td>
								<div class="form-group" style="margin-top:15px">
									<label class="control-label" for="fb_verification"> Facebook Vification </label>
									<div>
										<textarea id="fb_verification" name="fb_verification" class="form-control"><?php echo $selected->fb_verification ?? ''; ?></textarea>
									</div>
								</div>
							</td>
								</tr>
						<tr>
							<td>
								<div class="form-group" style="margin-top:15px">
									<label class="control-label" for="fb_pixel"> Facebook Pixel ID </label>
									<div>
										<textarea id="fb_pixel" name="fb_pixel" class="form-control"><?php echo $selected->fb_pixel ?? ''; ?></textarea>
									</div>
								</div>
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<a href="/sitemap_generate">Site Map Generate</a>
							</td>
						</tr>
					</table>
							...
							<tbody>
								<tr v-for="(branch, sl) in branches">
									...
									<td>
										...
										<a href="" title="Edit Branch" @click.prevent="editBranch(branch)"><i class="ri-edit-2-line"></i></a>&nbsp;
										<a href="" title="Deactive Branch" v-if="branch.status == 'a'" @click.prevent="changeStatus(branch.brunch_id)"><i class="ri-delete-bin-line"></i></a>
