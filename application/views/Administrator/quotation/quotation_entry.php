...
<div id="quotation" class="row">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			...
			<div class="form-group">
				<label class="col-md-1 control-label no-padding-right"> Quot. By </label>
				<div class="col-md-3">
	...
	new Vue({
		...
		methods: {
			...
			saveQuotation() {
				...
				this.quotation.employeeId = this.selectedEmployee == null ? null : this.selectedEmployee.Employee_SlNo;
