...
<div id="purchaseorderInvoiceReport" class="row">
  ...
  <div class="col-md-8 col-md-offset-2">
    <br>
    <purchaseorder-invoice v-bind:purchase_id="selectedInvoice.PurchaseMaster_SlNo" v-if="showInvoice"></purchaseorder-invoice>
  </div>
</div>
