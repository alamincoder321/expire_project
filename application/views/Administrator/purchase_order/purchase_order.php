					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<div class="col-xs-8">
									<input type="text" class="form-control" v-model="selectedSupplier.Supplier_Address" v-bind:disabled="selectedSupplier.Supplier_Type == 'G' || selectedSupplier.Supplier_Type == 'N' ? false : true" />
								</div>
							</div>
						</div>
							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;">
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">Invoice</label>
												<div class="col-xs-12">
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-xs-12 control-label no-padding-right">Purchase Date</label>
												<div class="col-xs-12">
										...
										<td>
											<div class="form-group">
												<div class="col-xs-7" style="margin-top: 5px;">
													<input type="button" class="btn btn-success" value="Purchase Order" v-on:click="savePurchase" v-bind:disabled="purchaseOnProgress == true ? true : false" style="background:#007ebb !important;border:0 !important;color:#fff;padding:3px;width:100%;">
												</div>
	...
	new Vue({
		...
		methods: {
			...
			savePurchase() {
				...
				let url = '/add_purchase_order';
				if (this.purchase.purchaseId != 0) {
					url = '/update_purchase_order';
				}
			...
			async getPurchase() {
				await axios.post('/get_purchase_orders', {
