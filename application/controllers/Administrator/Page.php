...
class Page extends CI_Controller
{
    ...
    public function company_profile_Update()
    {
        ...
        $data['googleVerification'] = $this->input->post('googleVerification', true);
        $data['gtagId'] = $this->input->post('gtagId', true);
        $data['bingVerification'] = $this->input->post('bingVerification', true);
        $data['fb_verification'] = $this->input->post('fb_verification', true);
        $data['fb_pixel'] = $this->input->post('fb_pixel', true);
